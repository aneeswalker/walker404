...
nocache('../message/help.js', module => console.log(color('[WATCH]', 'cyan'), color(`'${module}'`, 'green'), 'File is updated!'))
	...
	console.log(color(figlet.textSync('WALKER 404', {
		font: 'Standard',
	...
	console.log(color('[walker]', 'cyan'), color('WELCOME', 'white'))
	console.log(color('[walker]', 'cyan'), color('BOT RUNNING', 'yellow'))
	bosco.browserDescription = ["WALKER 404 - [WALKER-404]", "edge", "3.0.0"];
...
`
            ...
            promoteButt = { contentText: `${teks}`, footerText: `𝑷𝑹𝑶𝑴𝑶𝑻𝑬 𝑫𝑬𝑪𝑻𝑬𝑪𝑻𝑬𝑻`, buttons: promoteBut, headerType: 6, locationMessage: bosco2.message.locationMessage}
